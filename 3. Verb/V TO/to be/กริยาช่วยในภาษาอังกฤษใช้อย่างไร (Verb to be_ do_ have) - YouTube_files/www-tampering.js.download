...
;var F={},G=null;var H="function"===typeof Uint8Array;var I="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function J(a){Object.isFrozen(a)||(I?a[I]|=1:void 0!==a.g?a.g|=1:Object.defineProperties(a,{g:{value:1,configurable:!0,writable:!0,enumerable:!1}}));return a}
;function K(a){return null!==a&&"object"===typeof a&&!Array.isArray(a)&&a.constructor===Object}
var L=Object.freeze(J([])),M="undefined"!=typeof Symbol&&"undefined"!=typeof Symbol.hasInstance;function N(a){var b=da;b=void 0===b?ea:b;return O(a,b)}
function P(a,b){if(null!=a){if(Array.isArray(a))a=O(a,b);else if(K(a)){var c={},d;for(d in a)c[d]=P(a[d],b);a=c}else a=b(a);return a}}
function O(a,b){for(var c=a.slice(),d=0;d<c.length;d++)c[d]=P(c[d],b);if(Array.isArray(a)){var h;I?h=a[I]:h=a.g;a=!!((null==h?0:h)&1)}else a=!1;a&&J(c);return c}
...
G[f]&&(G[f]=m)}}}b=F[b];c=Array(Math.floor(a.length/3));d=b[64]||"";for(h=k=0;k<a.length-2;k+=3){var e=a[k],g=a[k+1];f=a[k+2];m=b[e>>2];e=b[(e&3)<<4|g>>4];g=b[(g&15)<<2|f>>6];f=b[f&63];c[h++]=""+m+e+g+f}m=0;f=d;switch(a.length-k){case 2:m=a[k+1],f=b[(m&15)<<2]||d;case 1:a=a[k],c[h]=""+b[a>>2]+b[(a&3)<<4|m>>4]+f+d}a=c.join("")}}return Array.isArray(a)?N(a):a}
function ea(a){return H&&null!=a&&a instanceof Uint8Array?new Uint8Array(a):a}
;var Q;function R(a,b,c){var d=Q;Q=null;a||(a=d);d=this.constructor.j;a||(a=d?[d]:[]);this.g=(d?0:-1)-(this.constructor.g||0);this.m=void 0;this.i=a;a:{d=this.i.length;a=d-1;if(d&&(d=this.i[a],K(d))){this.j=a-this.g;this.l=d;break a}void 0!==b&&-1<b?(this.j=Math.max(b,a+1-this.g),this.l=void 0):this.j=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)if(a=c[b],a<this.j)a+=this.g,(d=this.i[a])?Array.isArray(d)&&J(d):this.i[a]=L;else{d=this.l||(this.l=this.i[this.j+this.g]={});var h=d[a];h?Array.isArray(h)&&J(h):
d[a]=L}}
R.prototype.toJSON=function(){return N(this.i)};
R.prototype.toString=function(){return this.i.toString()};function S(){R.apply(this,arguments)}
B(S,R);function fa(){var a={};Object.defineProperties(S,(a[Symbol.hasInstance]={value:Object[Symbol.hasInstance],configurable:!1,writable:!1,enumerable:!1},a))}
M&&fa();function ha(a,b){var c=this.g,d=!0;a.m||(a.m={});var h=b?b.i:b;a.m[c]=b;b=void 0===d?!1:d;c<a.j&&(void 0===b||!b)?a.i[c+a.g]=h:(a.l||(a.l=a.i[a.j+a.g]={}))[c]=h;return a}
;function T(){S.apply(this,arguments)}
B(T,S);function ia(){var a={};Object.defineProperties(T,(a[Symbol.hasInstance]={value:Object[Symbol.hasInstance],configurable:!1,writable:!1,enumerable:!1},a))}
M&&ia();var U=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function V(a){return a?decodeURI(a):a}
;function W(a){T.call(this,a,1)}
B(W,T);function X(a){T.call(this,a)}
B(X,T);var ja=new function(a){this.g=a;this.j=ha}(406606992,X);function Y(){X.apply(this,arguments)}
B(Y,X);var Z=D.window,ka,la,ma=(null==Z?void 0:null==(ka=Z.yt)?void 0:ka.config_)||(null==Z?void 0:null==(la=Z.ytcfg)?void 0:la.data_)||{},na,oa=(null==Z?void 0:null==(na=Z.ytcfg)?void 0:na.obfuscatedData_)||[];function pa(){W.apply(this,arguments)}
B(pa,W);var qa=new pa(oa),ra=ma.EXPERIMENT_FLAGS;if(!ra||!ra.jspb_i18n_extension){var sa=new Y;ja.j(qa,sa)}E("yt.config_",ma);E("yt.configJspb_",oa);Object.freeze(["js-httpswwwgoogleanalyticscomanalyticsjs","js-chromeextensionpkedcjkdefgpdelpbcmbmeomcjbeemfm","video-","js-http","css-http"]);
var ta=Object.freeze("document.appendChild document.body.appendChild document.querySelector document.querySelectorAll history.back history.go".split(" ")),ua=Object.freeze("fonts.googleapis.com s0.2mdn.net securepubads.g.doubleclick.net ssl.google-analytics.com static.doubleclick.net www.google-analytics.com www.googletagservices.com www.youtube.com youtube.com".split(" ")),va=Object.freeze(["pkedcjkdefgpdelpbcmbmeomcjbeemfm","fjhoaacokmgbjemoflkofnenfaiekifl","enhhojjnijigcajfphajepfemndkmdlo"]),
wa=Object.freeze(".corp.google.com .googlevideo.com .ytimg.com .google.com .googlesyndication.com .gstatic.com .prod.google.com .google.ru".split(" ")),xa=Object.freeze(["chrome-extension","safari-extension","safari-resource","opera"]);function ya(){return ta.map(function(a){return za(a)}).filter(function(a){return!!a})}
function za(a){var b=a.split(".");a=b[b.length-1];b=b.reduce(function(c,d){return c&&c[d]},window);
...
function Aa(a){var b=a.match(U)[1]||null;return xa.some(function(c){return b==c})}
function Ba(a){var b=V(a.match(U)[3]||null);return!b||Aa(a)?!0:ua.some(function(c){return b==c})||wa.some(function(c){return b.endsWith(c)})}
function Ca(a){if(!Aa(a))return null;var b=V(a.match(U)[3]||null);return b?va.some(function(c){return b==c})?null:b:null}
function Da(){var a=new Set;[].concat(w(document.querySelectorAll("script"))).forEach(function(b){b.src&&!Ba(b.src)&&a.add(b.src)});
[].concat(w(document.querySelectorAll("link[href]"))).forEach(function(b){"alternate"==b.rel||Ba(b.href)||a.add(b.href)});
return[].concat(w(a)).sort()}
function Ea(){var a=new Set;[].concat(w(document.querySelectorAll("script"))).forEach(function(b){b.src&&(b=Ca(b.src))&&a.add(b)});
return[].concat(w(a)).sort()}
;E("ytbin.polymer.shared.lib.tampering.info",function(){var a=Da(),b=ya(),c=Ea(),d=[];c.length&&d.push("extensions",c);a.length&&d.push("suspiciousIncludes",a);b.length&&d.push("suspiciousApis",b);return d.length?d:null});}).call(this);
